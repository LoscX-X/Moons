...
final class Player {
    ...
    static ModuleRegistry.Module autoLava() {
        return module(
                ...
                number(
                        ...
                        .01,
                        AutoLava::setChance),
                number("range", "Range", "autolava.range", 4.5, 2, 6, .1, AutoLava::setRange),
                number("fov", "FOV", "autolava.fov", 90, 1, 360, 1, AutoLava::setFov),
                bool("wall", "Wall", "autolava.wall", true, AutoLava::setWallEnabled),
                bool("ground", "Ground", "autolava.ground", true, AutoLava::setGroundEnabled),
                integer(
                        "trigger_delay",
                        "Trigger delay ms",
                        "autolava.triggerDelayMs",
                        100,
                        0,
                        1000,
                        5,
                        AutoLava::setTriggerDelayMs),
                integer(
                        "switch_delay",
                        "Switch delay ms",
                        "autolava.switchDelayMs",
                        50,
                        0,
                        500,
                        5,
                        AutoLava::setSwitchDelayMs),
                number(
                        "prediction",
                        "Prediction",
                        "autolava.prediction",
                ...
                integer(
                        "prediction_delay",
                        "Prediction delay ms",
                        "autolava.predictionDelayMs",
                        20,
                        0,
                        250,
                        5,
                        AutoLava::setPredictionDelayMs),
                integer(
                        "pickup_delay",
                        "Pickup delay ms",
                        "autolava.pickupDelayMs",
                        15,
                        0,
                        1000,
                        1,
                ...
                integer(
                        "return_switch_delay",
                        "Return switch delay ms",
                        "autolava.returnSwitchDelayMs",
                        0,
                        0,
                        500,
                        1,
                        AutoLava::setReturnSwitchDelayMs),
                integer(
                        "smooth",
                        "Smooth turn",
                        "autolava.smoothTicks",
                        3,
                        1,
                        10,
                        1,
    ...
    static ModuleRegistry.Module antiLava() {
        return module(
                ...
                cfgBool("antilava.enabled", false),
                AntiLava::setEnabled,
                () -> "Predict",
                rangeInts(
                        "delay",
    ...
    static ModuleRegistry.Module antiWeb() {
        return module(
                ...
                bool(
                        "anti_antiweb",
                        "Anti-antiweb",
                        "antiweb.antiAntiWeb.enabled",
                        false,
                        AntiWeb::setAntiAntiWebEnabled),
                number(
                        "anti_antiweb_range",
                        "Anti-antiweb range",
                        "antiweb.antiAntiWeb.range",
                        4.5,
                        1,
                        6,
                        .1,
                ...
                integer(
                        "anti_antiweb_smooth",
                        "Anti-antiweb smooth ticks",
                        "antiweb.antiAntiWeb.smoothTicks",
                        2,
                        1,
                        20,
                        1,
    ...
    static ModuleRegistry.Module autoSword() {
        return module(
                ...
                "AutoSword",
                "Combat",
                cfgBool("autosword.enabled", false),
                AutoSword::setEnabled,
                AutoSword::statusText,
                integer("slot", "Sword slot", "autosword.slot", 0, 0, 8, 1, AutoSword::setSlot),
                bool(
                        "switch_back",
                        "Switch back",
                        "autosword.switchback",
                        false,
                        AutoSword::setSwitchBack),
                integer(
                        "switch_delay",
                        "Switch-back delay",
                        "autosword.switchbackdelay",
                        20,
                        1,
                        100,
                        1,
    ...
    static ModuleRegistry.Module autoHead() {
        return module(
                "autohead",
                "AutoHead",
                ...
                AutoHead::setEnabled,
                () -> "UHC",
                integer("health", "Health", "autohead.health", 15, 1, 20, 1, AutoHead::setHealth),
                rangeInts(
                        "delay",
                        "Delay ms",
                        "autohead.delay.min",
    ...
    static ModuleRegistry.Module autoTotem() {
        return module(
                ...
                bool(
                        ...
                        true,
                        AutoTotem::setExplosionEntities),
                bool(
                        "explosion_blocks",
                        "Explosion blocks",
                        "autototem.explosionblocks",
                        false,
                        AutoTotem::setExplosionBlocks),
                bool(
                        "fall_damage",
                        "Fall damage",
                        "autototem.falldamage",
                        true,
                        AutoTotem::setFallDamage),
                bool(
                        "ignore_elytra",
                        "Ignore elytra",
                        "autototem.fallignoreelytra",
                        false,
                        AutoTotem::setIgnoreElytra),
                integer(
                        "switch_delay",
                        "Switch delay",
                        "autototem.switchdelay",
                        0,
                        0,
                        500,
                        5,
