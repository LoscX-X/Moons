...
public final class AutoClicker {
    ...
    private static final IntSetting SAG_BLOCK_TICKS =
            integer("autoclicker.sagBlockingTicks", 4, 0, 20);
    private static final IntSetting SAG_UNBLOCK_TICKS =
            integer("autoclicker.sagUnblockTicks", 0, 0, 20);
    ...
    public static void init() {
        EventBus.TICK.register("AutoClicker.tick", event -> tick(event.client()));
    }
    ...
    public static String hudTag() {
        return format(MIN_CPS.get()) + "-" + format(MAX_CPS.get());
    }

    public static int setMinCps(Minecraft ignoredClient, double value) {
        MIN_CPS.set(value);
        return 1;
    }

    public static int setMaxCps(Minecraft ignoredClient, double value) {
        MAX_CPS.set(value);
        return 1;
    }

    public static int setBreakBlocks(Minecraft ignoredClient, boolean value) {
        BREAK_BLOCKS.set(value);
        return 1;
    }

    public static int setSag(Minecraft ignoredClient, boolean value) {
        SAG.set(value);
        return 1;
    }

    public static int setSagBlockingTicks(Minecraft ignoredClient, int value) {
        SAG_BLOCK_TICKS.set(value);
        return 1;
    }

    public static int setSagUnblockTicks(Minecraft ignoredClient, int value) {
        SAG_UNBLOCK_TICKS.set(value);
        return 1;
    }
