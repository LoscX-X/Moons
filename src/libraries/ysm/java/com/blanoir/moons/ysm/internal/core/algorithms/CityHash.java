package com.blanoir.moons.ysm.internal.core.algorithms;
...
public class CityHash {
    ...
    public long hash64(byte[] byteArray, int base, int len) {
        ...
        long z =
                hashLen16(
                        fetch64(byteArray, base + len - 48) + len,
                        fetch64(byteArray, base + len - 24));
        ...
        do {
            ...
            // w = weakHashLen32WithSeeds(byteArray, pos + 32, z + wHi, y + fetch64(byteArray, pos +
            // 16));
            {
    ...
    private Number128 hash128WithSeed(final byte[] byteArray, int start, final Number128 seed) {
        ...
        for (int tail_done = 0; tail_done < len; ) {
            ...
            v =
                    weakHashLen32WithSeeds(
                            byteArray, pos + len - tail_done, v.getLowValue() + z, v.getHiValue());
            v.setLowValue(v.getLowValue() * k0);
        }
        x = hashLen16(x, v.getLowValue());
        y = hashLen16(y + z, w.getLowValue());
        return new Number128(
                hashLen16(x + v.getHiValue(), w.getHiValue()) + y,
    ...
    public static void main(String[] args) {
        byte[] input =
                new byte[] {
                    (byte) 0x01, (byte) 0x7B, (byte) 0x88, (byte) 0x21, (byte) 0x12, (byte) 0x63,
                            (byte) 0x9A, (byte) 0xEE,
                    (byte) 0x6A, (byte) 0xBD, (byte) 0xED, (byte) 0xAD, (byte) 0xA2, (byte) 0xBD,
                            (byte) 0xFC, (byte) 0xF1,
                    (byte) 0x9B, (byte) 0xE2, (byte) 0xD6, (byte) 0xF8, (byte) 0xC7, (byte) 0x8F,
                            (byte) 0x0A, (byte) 0xE5,
                    (byte) 0x05, (byte) 0x0A, (byte) 0x6B, (byte) 0xE1, (byte) 0x0D, (byte) 0xD4,
                            (byte) 0xEC, (byte) 0xE5,
                    (byte) 0x29, (byte) 0xAE, (byte) 0x35, (byte) 0x3C, (byte) 0x54, (byte) 0xE8,
                            (byte) 0x8F, (byte) 0xF4,
                    (byte) 0x5C, (byte) 0x80, (byte) 0xCD, (byte) 0x1B, (byte) 0x0F, (byte) 0xD3,
                            (byte) 0x76, (byte) 0xFE,
                    (byte) 0x7B, (byte) 0xC2, (byte) 0x41, (byte) 0x65, (byte) 0x52, (byte) 0xA9,
                            (byte) 0x48, (byte) 0xFE,
                    (byte) 0xC0, (byte) 0x46, (byte) 0x09, (byte) 0x00, (byte) 0x32, (byte) 0x02,
                            (byte) 0x00, (byte) 0x00,
                    (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                            (byte) 0x00, (byte) 0x00,
                    (byte) 0x58, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                            (byte) 0x00, (byte) 0x00,
                    (byte) 0x5F, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                            (byte) 0x00, (byte) 0x00,
                    (byte) 0xB0, (byte) 0xB5, (byte) 0x43, (byte) 0xD5, (byte) 0xFC, (byte) 0x7F,
                            (byte) 0x00, (byte) 0x00,
                    (byte) 0x7F, (byte) 0x41, (byte) 0x5B, (byte) 0xB1, (byte) 0x14, (byte) 0x03,
                            (byte) 0xC3, (byte) 0x7D,
                    (byte) 0x5E, (byte) 0x73, (byte) 0x40, (byte) 0xEE, (byte) 0x00, (byte) 0x01,
                            (byte) 0x81, (byte) 0x91,
