...
import static com.blanoir.moons.ysm.internal.core.zstd.Huffman.MAX_SYMBOL;
import static com.blanoir.moons.ysm.internal.core.zstd.Huffman.MAX_SYMBOL_COUNT;
...
import static com.blanoir.moons.ysm.internal.core.zstd.Util.put24BitLittleEndian;
...
final class ZstdFrameCompressor {
    ...
    public static int compress(
        ...
        output +=
                writeFrameHeader(
                        outputBase, output, outputLimit, inputSize, parameters.getWindowSize());
        output +=
                compressFrame(
                        inputBase,
                        inputAddress,
    ...
    static int compressFrame(
        ...
        do {
            checkArgument(
                    outputSize >= SIZE_OF_BLOCK_HEADER + MIN_BLOCK_SIZE, "Output buffer too small");
    ...
    static int writeCompressedBlock(
            ...
            boolean lastBlock) {
        checkArgument(
                lastBlock || blockSize == context.parameters.getBlockSize(),
                "Only last block can be smaller than block size");
    ...
    private static int rleLiterals(
        ...
        UNSAFE.putByte(
                outputBase, outputAddress + headerSize, UNSAFE.getByte(inputBase, inputAddress));
