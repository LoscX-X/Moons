...
public final class DoubleSetting {
    ...
    public static final class Builder {
        ...
        public Builder defaultValue(double value) { this.defaultValue = value; return this; }
        public Builder min(double value) { this.min = value; return this; }
        public Builder max(double value) { this.max = value; return this; }
        ...
        public DoubleSetting build() {
            ...
            if (min > max) throw new IllegalStateException("Setting min cannot be greater than max.");
