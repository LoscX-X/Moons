...
final class YsmEquipmentLayers {
    ...
    private void head(
        ...
        try {
            ...
            ItemStackRenderState head = new ItemStackRenderState();
            Minecraft.getInstance()
                    .getItemModelResolver()
                    .updateForLiving(head, stack, ItemDisplayContext.HEAD, player);
            head.submit(pose, collector, light, OverlayTexture.NO_OVERLAY, 0);
        } finally {
            pose.popPose();
        }
    }
