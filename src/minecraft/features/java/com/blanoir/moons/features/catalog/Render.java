...
final class Render {
    ...
    static ModuleRegistry.Module blockAnimation() {
        return module(
                ...
                number(
                        "speed",
                        "Swing speed",
                        "blockanimation.swingSpeed",
                        1,
                        .1,
                        2,
                        .001,
                        Animations::setSwingSpeed),
                number(
                        "offset_x",
                        "Offset X",
                        "blockanimation.offsetX",
                        0,
                        -5,
                        5,
                        .001,
                        Animations::setOffsetX),
                number(
                        "offset_y",
                        "Offset Y",
                        "blockanimation.offsetY",
                        0,
                        -5,
                        5,
                        .001,
                        Animations::setOffsetY),
                number(
                        "offset_z",
                        "Offset Z",
                        "blockanimation.offsetZ",
                        0,
                        -5,
                        5,
                        .001,
                        Animations::setOffsetZ),
                number(
                        "scale",
                        "Scale",
                ...
                number(
                        "item_size",
                        "Item size",
                        "blockanimation.itemSize",
                        0,
                        -.5,
                        .5,
                        .001,
                        Animations::setItemSize),
                number(
                        "item_rotation_x",
                        "Item rotation X",
                        "blockanimation.itemRotationX",
                        0,
                        -180,
                        180,
                        1,
                        Animations::setItemRotationX),
                number(
                        "item_rotation_y",
                        "Item rotation Y",
                        "blockanimation.itemRotationY",
                        0,
                        -180,
                        180,
                        1,
                        Animations::setItemRotationY),
                number(
                        "ITEM_ROTATION_Z",
                        "Item rotation Z",
                        "blockanimation.itemRotationZ",
                        0,
                        -180,
                        180,
                        1,
                        Animations::setItemRotationZ));
    }
    ...
    static ModuleRegistry.Module inventory() {
        return module(
                ...
                "InventorySee",
                ModuleCategories.RENDER,
                InventorySee::isEnabled,
                InventorySee::setEnabled,
                () -> "",
                number(
                        "scale",
                        "Scale",
    ...
    static ModuleRegistry.Module chams() {
        return module(
                ...
                "Chams",
                "Render",
                () -> Chams.isHighlighterEnabled() || Chams.isChamsEnabled(),
                (client, value) -> {
                    Chams.setHighlighterEnabled(value);
                    Chams.setChamsEnabled(value);
                    return 1;
                },
                () -> "",
                bool(
    ...
    static ModuleRegistry.Module fullBright() {
        return module(
                ...
                integer(
                                ...
                                15,
                                1,
                                FullBright::setBrightness)
                        .visibleWhen(FullBright::gammaMode));
    }
    ...
    static ModuleRegistry.Module clip() {
        return module(
                "clip", "Clip", "Render", Clip::isEnabled, Clip::setEnabled, Clip::statusText);
    }
