...
public final class ModelOverlayMaterials {
    ...
    public record Capture(RenderType layer, boolean exclusive) {}
    ...
    private static RenderType mark(RenderType base, OutputTarget target, boolean exclusive) {
        ...
        RenderType capture = GameAccess.copyRenderType(base, name + "_capture", target);
        CAPTURES.put(marker, new Capture(capture, exclusive));
