...
import static com.blanoir.moons.ysm.internal.core.zstd.FiniteStateEntropy.MAX_SYMBOL;
import static com.blanoir.moons.ysm.internal.core.zstd.FiniteStateEntropy.MIN_TABLE_LOG;
...
class FseTableReader {
    ...
    public int readFseTable(
        ...
        int position =
                FseCompressionTable.spreadSymbols(
                        normalizedCounters, maxSymbol, tableSize, highThreshold, table.symbol);
