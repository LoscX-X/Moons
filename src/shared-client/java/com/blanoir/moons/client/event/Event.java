...
public class Event<T> {
    ...
    public void register(
        ...
        RegisteredListener<T> registration = new RegisteredListener<>(
                readableName(listenerName, listener), priority, listener);
    ...
    private void reportFailure(String listenerName, Throwable failure) {
        System.err.println("[EventBus] Event '" + name + "' listener '"
                + listenerName + "' failed: " + failure);
