...
/** Minecraft 26.1.2 observations for the portable Molang bindings. */
final class YsmObservations {
    ...
    Map<String, Object> sample(LocalPlayer p, AvatarRenderState s) {
        ...
        q.put("is_swinging", p.swinging);
        q.put("swinging", p.swinging);
        q.put("swing_time", p.swingTime);
        q.put("attack_time", s.attackTime);
        q.put("swinging_hand", p.swingingArm == InteractionHand.OFF_HAND ? "offhand" : "mainhand");
        q.put("swinging_arm", p.swingingArm == InteractionHand.OFF_HAND ? 1 : 0);
        ...
        q.put("query.swing_time", p.swingTime / 20d);
    ...
    com.blanoir.moons.ysm.internal.runtime.LocalRuntime.ObservationView view(float partial) {
        ...
        Minecraft.getInstance()
                ...
                .extractRenderState(player, state, partial);
