...
public final class AttachTarget {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        URL fixtureJar = AttachTarget.class.getProtectionDomain()
    ...
    private static void runFixture(ClassLoader gameLoader) throws Exception {
        ...
        Class<?> minecraftClass = Class.forName(
                "net.minecraft.client.Minecraft", true, gameLoader);
        ...
        System.out.println("MOONS_FIXTURE_READY pid=" + ProcessHandle.current().pid()
                ...
                if (loaded == null) {
                    if (name.startsWith("java.") || name.startsWith("jdk.")) {
                        ...
                        throw new ClassNotFoundException(
                                "Genesis-like loader rejected " + name);
                    }
                }
