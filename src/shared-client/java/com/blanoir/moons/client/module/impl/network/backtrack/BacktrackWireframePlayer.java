...
public final class BacktrackWireframePlayer {
    ...
    private static final AABB RENDER_HEAD = HEAD.move(
            -LIMB.maxX,
            LIMB.maxY * 2,
            -HEAD.maxZ * 0.25
    );
    ...
    private void renderStanding(PoseStack matrices, int color, int outlineColor) {
        renderPart(matrices, RENDER_LEFT_LEG, color, outlineColor, center(RENDER_LEFT_LEG), 0f, 0f, 0f);
        renderPart(matrices, RENDER_RIGHT_LEG, color, outlineColor, center(RENDER_RIGHT_LEG), 0f, 0f, 0f);
        renderPart(matrices, RENDER_BODY, color, outlineColor, center(RENDER_BODY), 0f, 0f, 0f);
        renderPart(matrices, RENDER_LEFT_ARM, color, outlineColor, center(RENDER_LEFT_ARM), 0f, 0f, 0f);
        renderPart(matrices, RENDER_RIGHT_ARM, color, outlineColor, center(RENDER_RIGHT_ARM), 0f, 0f, 0f);
        renderPart(
                matrices,
                RENDER_HEAD,
                color,
    ...
    private void renderCrouching(PoseStack matrices, int color, int outlineColor) {
        renderPart(matrices, CROUCH_LEFT_LEG, color, outlineColor, center(CROUCH_LEFT_LEG), 0f, 0f, 0f);
        renderPart(matrices, CROUCH_RIGHT_LEG, color, outlineColor, center(CROUCH_RIGHT_LEG), 0f, 0f, 0f);
        renderPart(
                matrices,
                CROUCH_BODY,
                color,
    ...
    private void renderSwimming(PoseStack matrices, int color, int outlineColor) {
        ...
        matrices.translate(
                bodyCenter.x,
                bodyCenter.y + SWIM_ROOT_Y_OFFSET,
                bodyCenter.z
        );
