package com.blanoir.moons.ysm.internal.geckolib3.core.event;
...
public class SoundKeyFrameExecutor {
    ...
    public SoundKeyFrameExecutor(
            List<EventKeyFrame<String>> soundKeyFrames, AudioPlayerManager audioPlayerManager) {
    ...
    public void playSound(AnimatableEntity<?> entity, float currentTick, boolean playAudio) {
        while (!reachEnd()) {
            ...
            this.nextIndex++;
            if (playAudio
                    && !com.blanoir.moons.ysm.internal.runtime.ScalarMath.isNullOrEmpty(
                            sound.getEventData())) {
