...
public class Animation {
    ...
    // TODO
    // https://github.com/bernie-g/geckolib/blob/4d62f40ab2d33db3c9d15d6867608ebc74242413/common/src/main/java/com/geckolib/loading/definition/animation/ActorAnimation.java#L54
    // 没调用
    @Nullable public final IValue unKnowData1;

    @Nullable public final IValue unKnowData2;

    @Nullable public final IValue blendWeight;
    ...
    @Nullable public String sourceKey;

    public Animation(
            String animationName,
            double animationLength,
            ILoopType loop,
            @Nullable IValue unKnowData1,
            @Nullable IValue unKnowData2,
            @Nullable IValue blendWeight,
            @Nullable Boolean overridePrevAnim,
    ...
    public boolean isEmpty() {
        return this.boneAnimations.isEmpty()
                && this.soundKeyFrames.isEmpty()
                && this.particleKeyFrames.isEmpty()
                && this.customInstructionKeyframes.isEmpty();
    }
}
