...
public final class GameAccess {
    ...
    static {
        try {
            ...
            CREATE_RENDER_SETUP = setupLookup.findConstructor(
                    RenderSetup.class,
                    java.lang.invoke.MethodType.methodType(
                            void.class,
            ...
            SETUP_FIELDS = Map.ofEntries(
                    ...
                    Map.entry("bufferSize", setupLookup.findVarHandle(RenderSetup.class, "bufferSize", int.class))
            );
    ...
    public static RenderType copyRenderType(RenderType base, String name, OutputTarget outputTarget) {
        try {
            ...
            RenderSetup replacement = (RenderSetup) CREATE_RENDER_SETUP.invoke(
