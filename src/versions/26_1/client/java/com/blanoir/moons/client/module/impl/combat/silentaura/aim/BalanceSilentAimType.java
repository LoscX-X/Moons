...
public final class BalanceSilentAimType implements SilentAimType {
    ...
    @Override public double response(double smooth) { return 12.0D + smooth * 16.0D; }
    @Override public double maxYawSpeed() { return 660.0D; }
    @Override public double maxPitchSpeed() { return 440.0D; }
    ...
    public Correction correct(Rotation desired, float currentYaw, double time, boolean targetChanged) {
        ...
        double accelerationScale = 1.0D + AimMotionNoise.sample(
                time * 3.1D, seed ^ 0x94D049BB133111EBL) * 0.18D;
