...
public final class WorldOverlayRenderer {
    ...
    private static void renderPin(Matrix4fc positionMatrix, BufferBuilder buffer, ColoredPin pin) {
        OverlayGeometry.renderPin(positionMatrix, buffer, pin);
    }

    private static void renderFilledBox(
            Matrix4fc positionMatrix, BufferBuilder buffer, ColoredBox box) {
        OverlayGeometry.renderFilledBox(positionMatrix, buffer, box);
    }
