...
public final class PacketReceiveEvent {
    ...
    /**
     * Expansion intent collected before a bundle reaches packet-changing listeners.
     * The selected version adapter owns bundle recognition and child dispatch.
     */
    public static final class Bundle {
        private boolean expansionRequested;

        public void requestExpansion() {
            expansionRequested = true;
        }

        public boolean expansionRequested() {
            return expansionRequested;
        }
    }
    ...
    public static final class Pre implements Cancellable {
        ...
        public boolean bundleExpansionRequested() {
            return bundleExpansionRequested;
        }

        public void requestBundleExpansion() {
            bundleExpansionRequested = true;
        }
