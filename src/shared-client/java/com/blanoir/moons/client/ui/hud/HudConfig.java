...
final class HudConfig {
    ...
    static final BooleanSetting VISIBLE =
            new BooleanSetting.Builder()
                    .name("featurehud.enabled")
                    .defaultValue(true)
                    .build();

    static final BooleanSetting TEXT_SHADOW =
            new BooleanSetting.Builder()
                    .name("featurehud.textShadow")
                    .defaultValue(true)
                    .build();
    ...
    static final StringSetting COLOR =
            new StringSetting.Builder()
                    .name("featurehud.color")
                    .defaultValue("#c49a6c")
                    .build();

    static final BooleanSetting SHOW_TITLE =
            new BooleanSetting.Builder()
                    .name("featurehud.showTitle")
                    .defaultValue(true)
                    .build();
    ...
    static int showStatus(Minecraft client) {
        ClientChat.send(client, "Native feature HUD " + (VISIBLE.get() ? "enabled" : "disabled") + ".");
        return 1;
    }
    ...
    static Integer parseColor(String raw) {
        ...
        try {
            if (value.length() == 6) return 0xFF000000 | Integer.parseInt(value, 16);
