...
public final class ChestStealer {
    private static final BooleanSetting ENABLED =
            new BooleanSetting.Builder()
                    .name("cheststealer.enabled")
                    .defaultValue(false)
                    .build();

    private static final StringSetting ITEMS =
            new StringSetting.Builder()
                    .name("cheststealer.items")
                    .defaultValue("")
                    .build();
    ...
    public static void init() {
        EventBus.TICK.register("ChestStealer.tick", event -> {
    ...
    private static void tick(Minecraft client) {
        ...
        AbstractContainerMenu handler = ((AbstractContainerScreen<?>) MinecraftClientAccess.screen(client)).getMenu();
    ...
    public static int setMiss(Minecraft client, String missRange) {
        ...
        if (range == null) {
            ClientChat.send(client, "Invalid cheststealmiss value. Use milliseconds, e.g. .moons cheststealmiss 150 or .moons cheststealmiss 100-250.");
            return 0;
        }
