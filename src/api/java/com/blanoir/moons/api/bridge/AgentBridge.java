...
public final class AgentBridge {
    ...
    public static void onFrame(Object renderer, Object deltaTracker) {
        try { runtime.onFrame(renderer, deltaTracker); }
        catch (Throwable failure) { report("frame", failure); }
    }

    public static void onHudRender(Object gui, Object extractor, Object deltaTracker) {
        try { runtime.onHudRender(gui, extractor, deltaTracker); }
        catch (Throwable failure) { report("hud render", failure); }
    }
    ...
    public static void onWorldRender(
        ...
        try { runtime.onWorldRender(renderer, poseStack, levelRenderState, stage); }
        catch (Throwable failure) { report("world render", failure); }
    }

    public static boolean onKey(Object handler, long window, int action, Object event) {
        try { return runtime.onKey(handler, window, action, event); }
        catch (Throwable failure) { report("key", failure); return true; }
    }

    public static boolean onMouse(Object handler, long window, Object button, int action) {
        try { return runtime.onMouse(handler, window, button, action); }
        catch (Throwable failure) { report("mouse", failure); return true; }
    }

    public static boolean onMouseScroll(Object handler, long window, double xOffset, double yOffset) {
        try { return runtime.onMouseScroll(handler, window, xOffset, yOffset); }
        catch (Throwable failure) { report("mouse scroll", failure); return true; }
    }

    public static void onMouseMoveStart(Object handler) {
        try { runtime.onMouseMoveStart(handler); }
        catch (Throwable failure) { report("mouse move start", failure); }
    }

    public static void onMouseMoveEnd(Object handler) {
        try { runtime.onMouseMoveEnd(handler); }
        catch (Throwable failure) { report("mouse move end", failure); }
    }

    public static boolean onAttack(Object minecraft) {
        try { return runtime.onAttack(minecraft); }
        catch (Throwable failure) { report("attack", failure); return true; }
    }

    public static void onAttackEnd(Object minecraft) {
        try { runtime.onAttackEnd(minecraft); }
        catch (Throwable failure) { report("attack end", failure); }
    }

    public static boolean onUse(Object minecraft) {
        try { return runtime.onUse(minecraft); }
        catch (Throwable failure) { report("use", failure); return true; }
    }

    public static void onUseEnd(Object minecraft) {
        try { runtime.onUseEnd(minecraft); }
        catch (Throwable failure) { report("use end", failure); }
    }

    public static boolean onPacketSend(Object connection, Object packet) {
        try { return runtime.onPacketSend(connection, packet); }
        catch (Throwable failure) { report("packet send", failure); return true; }
    }

    public static void onPacketSent(Object connection, Object packet) {
        try { runtime.onPacketSent(connection, packet); }
        catch (Throwable failure) { report("packet sent", failure); }
    }

    public static boolean onPacketReceive(Object packet, Object listener) {
        try { return runtime.onPacketReceive(packet, listener); }
        catch (Throwable failure) { report("packet receive", failure); return true; }
    }

    public static void onPacketApply(Object packet, Object listener) {
        try { runtime.onPacketApply(packet, listener); }
        catch (Throwable failure) { report("packet apply", failure); }
    }

    public static void onBlockUpdateStart(Object level, Object position, Object newState) {
        try { runtime.onBlockUpdateStart(level, position, newState); }
        catch (Throwable failure) { report("block update start", failure); }
    }

    public static void onBlockUpdate(Object level, Object position, Object newState, boolean applied) {
        try { runtime.onBlockUpdate(level, position, newState, applied); }
        catch (Throwable failure) { report("block update", failure); }
    }

    public static boolean onPlayerUpdate(Object player) {
        try { return runtime.onPlayerUpdate(player); }
        catch (Throwable failure) { report("player update", failure); return true; }
    }

    public static void onMoveInput(Object player) {
        try { runtime.onMoveInput(player); }
        catch (Throwable failure) { report("move input", failure); }
    }
    ...
    public static void onPlayerMoveEnd(Object player) {
        try { runtime.onPlayerMoveEnd(player); }
        catch (Throwable failure) { report("player move end", failure); }
    }

    public static void onPlayerPositionStart(Object player) {
        try { runtime.onPlayerPositionStart(player); }
        catch (Throwable failure) { report("player position start", failure); }
    }

    public static void onPlayerPositionEnd(Object player) {
        try { runtime.onPlayerPositionEnd(player); }
        catch (Throwable failure) { report("player position end", failure); }
    }

    public static void onRenderState(Object entity, Object state, float partialTick) {
        try { runtime.onRenderState(entity, state, partialTick); }
        catch (Throwable failure) { report("render state", failure); }
    }

    public static void onRendererClose(Object renderer) {
        try { runtime.onRendererClose(renderer); }
        catch (Throwable failure) { report("renderer close", failure); }
    }

    public static void onVoidHook(String id, Object owner, Object argument) {
        try { runtime.onVoidHook(id, owner, argument); }
        catch (Throwable failure) { report(id, failure); }
    }
    ...
    public static boolean onBooleanValue(
            String id, Object owner, Object argument, boolean value) {
        try { return runtime.onBooleanValue(id, owner, argument, value); }
        catch (Throwable failure) { report(id, failure); return value; }
    }

    public static float onFloatValue(String id, Object owner, float argument, float value) {
        try { return runtime.onFloatValue(id, owner, argument, value); }
        catch (Throwable failure) { report(id, failure); return value; }
    }

    public static void requestUnload() {
        try { runtime.requestUnload(); }
        catch (Throwable failure) { report("runtime unload", failure); }
    }
