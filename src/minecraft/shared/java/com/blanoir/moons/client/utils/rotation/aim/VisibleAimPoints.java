...
public final class VisibleAimPoints {
    ...
    public static Vec3 findVisibleAimPoint(
        ...
        Vec3 steerPoint = AimPointUtils.closest(box, eyePos, look, range);
        ...
        if (preferredAimPoint != null
            ...
            double preferredAngle = RotationUtils.angleFromView(client, preferredAimPoint);

            double bestAngle = RotationUtils.angleFromView(client, bestPoint);
    ...
    private static Vec3 bestVisibleSample(
        ...
        for (Vec3 point : aimPoints(box)) {
            ...
            double angle = RotationUtils.angleFromView(client, point);
