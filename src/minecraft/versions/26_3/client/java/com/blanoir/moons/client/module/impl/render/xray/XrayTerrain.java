 ...
 *
 * <p>Minecraft 26.3 processes Caver at the final BlockQuadOutput boundary. Blocks
...
public final class XrayTerrain {
    /**
     * 96/255 is visible enough to preserve terrain context in the 26.3 pipeline.
     */
    private static final int BACKGROUND_ALPHA = 96;

    private static final ThreadLocal<Boolean> RENDERING_BACKGROUND =
    ...
    /**
     * 26.3 must not cancel tesselateBlock. SectionCompiler owns the output routing
