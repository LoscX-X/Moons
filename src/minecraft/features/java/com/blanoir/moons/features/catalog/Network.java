    ...
    static ModuleRegistry.Module backtrack() {
        return module(
                ...
                range(
                        ...
                        2000,
                        1,
                        Backtrack::setNextBacktrackDelay),
                integerText(
                        "tracking_buffer",
                        "Tracking buffer",
                ...
                bool(
                        "pause_hurt",
                        "Pause on hurt",
                        "backtrack.pauseOnHurtTime.enabled",
                        false,
                        Backtrack::setHurtEnabled),
                integerText(
                        "hurt_time",
                        "Hurt time",
                        "backtrack.pauseOnHurtTime.hurtTime",
                        3,
                        0,
                        10,
                        1,
                ...
                text(
                        ...
                        .visibleWhen(Backtrack::espEnabled)
                        .enabledWhen(() -> !Backtrack.modelEspSelected()),
                text(
                                "outline_color",
                                "Outline color",
                                Backtrack::espOutlineColor,
                                (client, value) -> Backtrack.setColor(client, value, true))
                        .visibleWhen(Backtrack::espEnabled),
                integerText(
                                "light",
                                "Model light %",
                                "backtrack.esp.model.lightPercent",
                                60,
                                0,
                                100,
                                1,
                                Backtrack::setLightPercent)
                        .visibleWhen(Backtrack::modelEspSelected));
    }
