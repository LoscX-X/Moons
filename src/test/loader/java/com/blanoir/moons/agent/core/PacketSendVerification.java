...
public final class PacketSendVerification {
    ...
    static void verify() throws Exception {
        MethodNode send =
                new MethodNode(Opcodes.ACC_PUBLIC, "send", "(Ljava/lang/Object;)V", null, null);
        send.instructions.add(new VarInsnNode(Opcodes.ALOAD, 1));
        send.instructions.add(
                new MethodInsnNode(
                        Opcodes.INVOKESTATIC, OWNER, "sentBody", "(Ljava/lang/Object;)V", false));
        ...
        Class<?> fixture =
                new ClassLoader(PacketSendVerification.class.getClassLoader()) {
                    Class<?> define() {
                        return defineClass("PacketSendFixture", code, 0, code.length);
                    }
                }.define();
