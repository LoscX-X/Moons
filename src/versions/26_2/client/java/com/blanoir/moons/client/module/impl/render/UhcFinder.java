...
public final class UhcFinder {
    ...
    public static int setEnabled(Minecraft client, boolean newEnabled) {
        ...
        ClientChat.send(client, "UhcFinder " + statusText() + ". Range: " + format(RANGE.get()) + ".");
        return 1;
    }
    ...
    private static boolean shouldRenderTarget(Minecraft client, LivingEntity entity, double maxDistanceSquared) {
    ...
    private static WorldOverlayRenderer.ColoredBox createEntityBox(LivingEntity entity, float tickDelta) {
