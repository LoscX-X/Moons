...
/** Keep authored GLFW key numbers stable across the 26.3 move to SDL scan codes. */
final class YsmInput {
    ...
    // Matched by key name against the actual 26.2 and 26.3 InputConstants tables.
