package com.blanoir.moons.ysm.internal.geckolib3.core.manager;
...
public class AnimationData {
    ...
    private final Object2ReferenceOpenHashMap<String, IAnimationController> animationControllerMap =
            new Object2ReferenceOpenHashMap<>(0);
    ...
    public IAnimationController getAnimationControllerByName(String name) {
        if (this.animationControllerMap.isEmpty() && !this.animationControllers.isEmpty()) {
            for (IAnimationController interfaceC0548xdbb43aa3 : this.animationControllers) {
                this.animationControllerMap.put(
                        interfaceC0548xdbb43aa3.getName(), interfaceC0548xdbb43aa3);
            }
        }
