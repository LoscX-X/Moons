package com.blanoir.moons.ysm.internal.geckolib3.core.snapshot;
...
public class BoneSnapshot {
    ...
    public void applyTransform(IBone bone) {
        ...
        this.rotation.set(
                bone.getRotationX() - initialRotation.x,
                bone.getRotationY() - initialRotation.y,
                bone.getRotationZ() - initialRotation.z);
