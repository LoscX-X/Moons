...
public final class CustomXrayTargets {
    ...
    public static synchronized AddResult add(String blockName, ColorValue color) {
        ...
        CustomTarget target = new CustomTarget(id, block, true, color.red(), color.green(), color.blue());
    ...
    private static void saveTargets() {
        Settings.setString(
                ...
                TARGETS.values().stream()
                        .map(target -> target.id() + "," + target.isEnabled() + "," + target.red() + "," + target.green() + "," + target.blue())
    ...
    public record AddResult(boolean success, Identifier id, CustomTarget target, boolean invalidBlock) {
    }
    ...
    public static final class CustomTarget implements XrayTarget {
        ...
        private CustomTarget(Identifier id, Block block, boolean enabled, int red, int green, int blue) {
            this.id = id;
            this.block = block;
