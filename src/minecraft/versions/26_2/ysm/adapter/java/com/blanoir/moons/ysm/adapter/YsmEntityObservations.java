...
final class YsmEntityObservations {
    static Map<String, Object> sample(
        ...
        if (entity instanceof LivingEntity living) {
            ...
            q.put("is_swinging", living.swinging);
            q.put("query.swing_time", living.swingTime / 20d);
            q.put("swing_time", living.swingTime);
            q.put("attack_time", living.getAttackAnim(partial));
            q.put(
                    "using_hand",
            ...
            q.put(
                    "swinging_hand",
                    living.swingingArm == net.minecraft.world.InteractionHand.OFF_HAND
                            ? "offhand"
                            : "mainhand");
