...
final class MinecraftVersionGuard {
    ...
    static void verify(Object minecraft, String expectedVersion) {
        ...
        if (minecraft == null) {
            throw new IllegalStateException("Minecraft instance is unavailable for version verification");
        }
        try {
            ClassLoader gameLoader = minecraft.getClass().getClassLoader();
            Class<?> sharedConstants = Class.forName(
                    "net.minecraft.SharedConstants", true, gameLoader);
            ...
            if (!expectedVersion.equals(actualVersion)) {
                throw new IllegalStateException("Unsupported Minecraft version " + actualVersion
