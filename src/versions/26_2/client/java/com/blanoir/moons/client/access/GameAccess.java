...
public final class GameAccess {
    ...
    private static final VarHandle RENDER_SETUP_BUFFER_SIZE;
    ...
    static {
        try {
            MethodHandles.Lookup keyLookup = MethodHandles.privateLookupIn(
                    KeyMapping.class, MethodHandles.lookup());
            KEY_MAP = keyLookup.findStaticVarHandle(KeyMapping.class, "MAP", Map.class);
            BOUND_KEY = keyLookup.findVarHandle(
                    KeyMapping.class, "key", InputConstants.Key.class);

            MethodHandles.Lookup mouseLookup = MethodHandles.privateLookupIn(
                    MouseHandler.class, MethodHandles.lookup());
            MOUSE_BUTTON = mouseLookup.findVirtual(
                    MouseHandler.class,
                    "onButton",
                    java.lang.invoke.MethodType.methodType(
                            void.class, long.class, MouseButtonInfo.class, int.class));

            START_ATTACK = MethodHandles.privateLookupIn(Minecraft.class, MethodHandles.lookup())
                    .findVirtual(Minecraft.class, "startAttack",
                            java.lang.invoke.MethodType.methodType(boolean.class));
            START_USE_ITEM = MethodHandles.privateLookupIn(Minecraft.class, MethodHandles.lookup())
                    .findVirtual(Minecraft.class, "startUseItem",
                            java.lang.invoke.MethodType.methodType(void.class));
            RIGHT_CLICK_DELAY = MethodHandles.privateLookupIn(Minecraft.class, MethodHandles.lookup())
                    .findVarHandle(Minecraft.class, "rightClickDelay", int.class);

            MethodHandles.Lookup renderLookup = MethodHandles.privateLookupIn(
                    RenderType.class, MethodHandles.lookup());
            ...
            CREATE_RENDER_TYPE = renderLookup.findStatic(
                    RenderType.class,
                    "create",
                    java.lang.invoke.MethodType.methodType(
                            RenderType.class, String.class, RenderSetup.class));

            MethodHandles.Lookup setupLookup = MethodHandles.privateLookupIn(
                    RenderSetup.class, MethodHandles.lookup());
            ...
            try {
                ...
                createRenderSetup = setupLookup.findConstructor(
                        ...
                        java.lang.invoke.MethodType.methodType(
                                ...
                                boolean.class,
                                boolean.class));
                renderSetupBufferSize = null;
            } catch (NoSuchMethodException alternateLayout) {
                // Also tolerate development/vendor snapshots which expose the
                // later bufferSize field without making GameAccess fail globally.
                createRenderSetup = setupLookup.findConstructor(
                        RenderSetup.class,
                        java.lang.invoke.MethodType.methodType(
                                void.class,
                                ...
                                boolean.class,
                                int.class));
                renderSetupBufferSize = setupLookup.findVarHandle(
                        RenderSetup.class, "bufferSize", int.class);
            }
            CREATE_RENDER_SETUP = createRenderSetup;
            RENDER_SETUP_BUFFER_SIZE = renderSetupBufferSize;
            SETUP_FIELDS = Map.ofEntries(
                    Map.entry("pipeline", setupLookup.findVarHandle(RenderSetup.class, "pipeline", RenderPipeline.class)),
                    Map.entry("textures", setupLookup.findVarHandle(RenderSetup.class, "textures", Map.class)),
                    Map.entry("useLightmap", setupLookup.findVarHandle(RenderSetup.class, "useLightmap", boolean.class)),
                    Map.entry("useOverlay", setupLookup.findVarHandle(RenderSetup.class, "useOverlay", boolean.class)),
                    Map.entry("layeringTransform", setupLookup.findVarHandle(RenderSetup.class, "layeringTransform", LayeringTransform.class)),
                    Map.entry("textureTransform", setupLookup.findVarHandle(RenderSetup.class, "textureTransform", TextureTransform.class)),
                    Map.entry("outlineProperty", setupLookup.findVarHandle(RenderSetup.class, "outlineProperty", RenderSetup.OutlineProperty.class)),
                    Map.entry("affectsCrumbling", setupLookup.findVarHandle(RenderSetup.class, "affectsCrumbling", boolean.class)),
                    Map.entry("sortOnUpload", setupLookup.findVarHandle(RenderSetup.class, "sortOnUpload", boolean.class))
            );

            NO_JUMP_DELAY = MethodHandles.privateLookupIn(LivingEntity.class, MethodHandles.lookup())
                    .findVarHandle(LivingEntity.class, "noJumpDelay", int.class);
            MOVE_VECTOR = MethodHandles.privateLookupIn(ClientInput.class, MethodHandles.lookup())
                    .findVarHandle(ClientInput.class, "moveVector", Vec2.class);
            BLOCK_STATE_PREDICTION_HANDLER = MethodHandles.privateLookupIn(
                    ClientLevel.class, MethodHandles.lookup()).findVarHandle(
                    ClientLevel.class, "blockStatePredictionHandler",
                    BlockStatePredictionHandler.class);
            QUAD_INSTANCE = MethodHandles.privateLookupIn(ModelBlockRenderer.class, MethodHandles.lookup())
                    .findVarHandle(ModelBlockRenderer.class, "quadInstance", QuadInstance.class);
            DISPATCH_INCOMING = MethodHandles.privateLookupIn(Connection.class, MethodHandles.lookup())
                    .findStatic(Connection.class, "genericsFtw",
                            java.lang.invoke.MethodType.methodType(
                                    void.class, Packet.class, PacketListener.class));
            ENTITY_EVENT_ID = MethodHandles.privateLookupIn(
            ...
            MethodHandles.Lookup pipelinesLookup = MethodHandles.privateLookupIn(
                    RenderPipelines.class, MethodHandles.lookup());
            REGISTER_PIPELINE = pipelinesLookup.findStatic(
                    RenderPipelines.class,
                    "register",
                    java.lang.invoke.MethodType.methodType(RenderPipeline.class, RenderPipeline.class));
            DEBUG_FILLED_SNIPPET = pipelinesLookup.findStaticVarHandle(
                    RenderPipelines.class,
                    "DEBUG_FILLED_SNIPPET",
                    RenderPipeline.Snippet.class);
            MethodHandles.Lookup tabLookup = MethodHandles.privateLookupIn(
                    PlayerTabOverlay.class, MethodHandles.lookup());
            ...
            SUBMIT_NODE_STORAGE = MethodHandles.privateLookupIn(
                    LevelRenderer.class, MethodHandles.lookup()).findVarHandle(
                    LevelRenderer.class, "submitNodeStorage", SubmitNodeStorage.class);
    ...
    @SuppressWarnings("unchecked")
    public static RenderType copyRenderType(RenderType base, String name, OutputTarget outputTarget) {
        try {
            RenderSetup setup = (RenderSetup) RENDER_SETUP.get(base);
            RenderSetup replacement;
            if (RENDER_SETUP_BUFFER_SIZE == null) {
                replacement = (RenderSetup) CREATE_RENDER_SETUP.invoke(
                ...
                replacement = (RenderSetup) CREATE_RENDER_SETUP.invoke(
                        ...
                        field(setup, "affectsCrumbling"),
                        field(setup, "sortOnUpload"),
                        RENDER_SETUP_BUFFER_SIZE.get(setup));
            }
    ...
    public static void withPredictionSequence(ClientLevel level, java.util.function.IntConsumer sender) {
    ...
    public static RenderPipeline registerPipeline(RenderPipeline pipeline) {
        try {
            ...
            throw new IllegalStateException("Unable to register Minecraft render pipeline", failure);
        }
    }
