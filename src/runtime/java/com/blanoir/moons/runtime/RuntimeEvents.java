...
public final class RuntimeEvents {
    ...
    public record MouseScroll(Object handler, long window, double xOffset, double yOffset, Control control) { }
    ...
    public static final class PlayerMove {
        ...
        public void scale(float replacement) { scale = replacement; }
        public Object movement() { return movement; }
    ...
    public static final class MethodHook {
        ...
        public Object argument() { return argument; }
        public Object value() { return value; }
        public void value(Object replacement) { value = replacement; }
    }

    public enum Kind { ATTACK, USE }
    public enum PacketPhase { SEND_PRE, SEND_POST, RECEIVE_NETWORK, RECEIVE_APPLY }
    ...
    public EventChannel<Frame> frame() { return frame; }
    public EventChannel<Hud> hud() { return hud; }
    public EventChannel<WorldRender> worldRender() { return worldRender; }
    public EventChannel<Key> key() { return key; }
    public EventChannel<Mouse> mouse() { return mouse; }
    public EventChannel<MouseScroll> mouseScroll() { return mouseScroll; }
    public EventChannel<Action> action() { return action; }
    public EventChannel<Packet> packet() { return packet; }
    public EventChannel<BlockUpdate> blockUpdate() { return blockUpdate; }
    public EventChannel<PlayerUpdate> playerUpdate() { return playerUpdate; }
    public EventChannel<MoveInput> moveInput() { return moveInput; }
    public EventChannel<PlayerMove> playerMove() { return playerMove; }
    public EventChannel<MouseMove> mouseMove() { return mouseMove; }
    public EventChannel<PlayerMoveEnd> playerMoveEnd() { return playerMoveEnd; }
    public EventChannel<PlayerPosition> playerPosition() { return playerPosition; }
    public EventChannel<RenderState> renderState() { return renderState; }
    public EventChannel<RendererClose> rendererClose() { return rendererClose; }
    public EventChannel<MethodHook> methodHook() { return methodHook; }
}
