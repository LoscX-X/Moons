package com.blanoir.moons.ysm.internal.geckolib3.core.molang.binding.variable;

import com.blanoir.moons.ysm.internal.geckolib3.core.molang.binding.ResetVariable;
import com.blanoir.moons.ysm.internal.geckolib3.core.molang.context.IContext;
import com.blanoir.moons.ysm.internal.geckolib3.core.molang.storage.IControllerVariableStorage;
...
public class ControllerVariableBinding implements ObjectBinding, ResetVariable {
    ...
    private final Int2ReferenceOpenHashMap<ControllerVariable> variableMap =
            new Int2ReferenceOpenHashMap<>();

    @Override
    public Object getProperty(String name) {
        return variableMap.computeIfAbsent(
                StringPool.computeIfAbsent(name), ControllerVariable::new);
    }
    ...
    private record ControllerVariable(int name) implements AssignableVariable {
        ...
        public Object evaluate(@NotNull ExecutionContext<?> context) {
            IControllerVariableStorage storage =
                    ((IContext<Object>) context.entity()).controllerStorage();
            if (storage != null) {
