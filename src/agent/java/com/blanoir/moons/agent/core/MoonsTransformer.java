...
final class MoonsTransformer implements ClassFileTransformer {
    ...
    boolean targets(String className) { return mappings.targetsClass(className); }
    String[] targetClassNames() { return mappings.targetClassNames(); }
    ...
    public byte[] transform(
        ...
        try {
            ...
            ClassWriter writer = recomputeFrames
            ...
            System.err.println(Branding.prefix() + " Skipping failed transformation for " + className + ": " + failure);
            return null;
        }
    }
    ...
    private static boolean injectHud(MethodNode method) {
        ...
        beforeReturns(method, Opcodes.RETURN, () -> {
            ...
            hook.add(call("onHudRender", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V"));
            return hook;
        });
        return true;
    }
    ...
    private static boolean injectBlockSet(MethodNode method) {
        ...
        beforeReturns(method, Opcodes.IRETURN, () -> {
            ...
            hook.add(call("onBlockUpdate", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V"));
            return hook;
        });
        return true;
    }
    ...
    private static InsnList blockUpdateStart() {
        ...
        hook.add(new VarInsnNode(Opcodes.ALOAD, 1));
        hook.add(new VarInsnNode(Opcodes.ALOAD, 2));
        hook.add(call("onBlockUpdateStart", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V"));
        return hook;
    }
    ...
    private static boolean injectMoveInput(MethodNode method) {
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            if (!(instruction instanceof MethodInsnNode invocation)
                    ...
                    || !invocation.desc.equals("()V")
                    || !invocation.owner.equals("net/minecraft/client/player/ClientInput")) continue;
            InsnList hook = new InsnList();
            hook.add(new VarInsnNode(Opcodes.ALOAD, 0));
    ...
    private static boolean injectPlayerMove(MethodNode method) {
        ...
        hook.add(new VarInsnNode(Opcodes.ALOAD, 2));
        hook.add(call("onPlayerMove", "(Ljava/lang/Object;FLjava/lang/Object;)[Ljava/lang/Object;"));
    ...
    private static boolean injectVoidHook(MethodNode method, String id, boolean atReturn) {
        ...
        else method.instructions.insert(factory.create());
        return true;
    }
    ...
    private static boolean injectObjectReturn(MethodNode method, String id) {
        ...
        beforeReturns(method, Opcodes.ARETURN, () -> {
            InsnList hook = new InsnList();
            hook.add(new VarInsnNode(Opcodes.ASTORE, result));
            hook.add(new LdcInsnNode(id));
            hook.add(new VarInsnNode(Opcodes.ALOAD, 0));
            hook.add(hasArgument ? new VarInsnNode(Opcodes.ALOAD, 1) : new InsnNode(Opcodes.ACONST_NULL));
            hook.add(new VarInsnNode(Opcodes.ALOAD, result));
            hook.add(call("onObjectValue", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
    ...
    private static boolean injectNamedFloatLocal(
        ...
        while (store != null && !(store instanceof VarInsnNode variable
    ...
    private static boolean injectSprintDecisions(MethodNode method) {
        ...
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            ...
            String id = switch (invocation.name) {
    ...
    private static boolean injectHandAnimation(MethodNode method, String id) {
        ...
        start.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                "com/mojang/blaze3d/vertex/PoseStack", "pushPose", "()V", false));
        ...
        start.add(new VarInsnNode(Opcodes.ALOAD, 4));
        start.add(new InsnNode(Opcodes.ICONST_0));
        start.add(call("onBooleanValue", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Z)Z"));
        ...
        start.add(new VarInsnNode(Opcodes.ALOAD, 1));
        start.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                "net/minecraft/client/player/AbstractClientPlayer", "getMainArm",
                "()Lnet/minecraft/world/entity/HumanoidArm;", false));
        start.add(new FieldInsnNode(Opcodes.GETSTATIC,
    ...
    private static boolean injectObjectInvocationReturn(MethodNode method, String id) {
        ...
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            ...
            hook.add(call("onObjectValue",
                    "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
            hook.add(new TypeInsnNode(Opcodes.CHECKCAST,
    ...
    private static boolean injectChamsFrame(MethodNode method, String id) {
        ...
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            ...
            if (invocation.owner.equals("net/minecraft/client/renderer/feature/FeatureRenderDispatcher$PreparedFrame")
    ...
    private static boolean injectSodiumProcessQuad(MethodNode method, String id) {
        ...
        for (AbstractInsnNode instruction : method.instructions) {
            if (instruction instanceof FieldInsnNode field
                ...
                forceOpaque = field;
                    ...
                    && invocation.desc.equals("()Lnet/minecraft/client/renderer/chunk/ChunkSectionLayer;")) {
        ...
        opaqueHook.add(call("onBooleanValue", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Z)Z"));
        ...
        layerHook.add(call("onObjectValue", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
        layerHook.add(new TypeInsnNode(
                Opcodes.CHECKCAST, "net/minecraft/client/renderer/chunk/ChunkSectionLayer"));
        ...
        alphaHook.add(call("onVoidHook", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V"));
    ...
    private static boolean injectChamsMarkItem26_2(MethodNode method, String id) {
        ...
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            if (instruction instanceof TypeInsnNode type
                    && instruction.getOpcode() == Opcodes.NEW
                    && type.desc.equals("net/minecraft/client/renderer/feature/ItemFeatureRenderer$Submit")) {
                sawSubmit = true;
                continue;
            }
            if (sawSubmit && instruction instanceof VarInsnNode variable
                    && instruction.getOpcode() == Opcodes.ASTORE) {
                InsnList hook = new InsnList();
                hook.add(new LdcInsnNode(id));
                hook.add(new VarInsnNode(Opcodes.ALOAD, 0));
    ...
    private static boolean injectXraySectionQuad26_2(MethodNode method, String id) {
        ...
        layerHook.add(call("onObjectValue",
                "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
        layerHook.add(new TypeInsnNode(Opcodes.CHECKCAST,
    ...
    private static boolean injectInvocationArgumentRemap(
        ...
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            ...
            org.objectweb.asm.Type[] arguments = org.objectweb.asm.Type.getArgumentTypes(invocation.desc);
            if (argumentIndex < 0 || argumentIndex >= arguments.length
                    || arguments[argumentIndex].getSort() != org.objectweb.asm.Type.OBJECT) continue;
            ...
            for (int index = arguments.length - 1; index >= argumentIndex; index--) {
                ...
                hook.add(new VarInsnNode(arguments[index].getOpcode(Opcodes.ISTORE), locals[index]));
            }
            hook.add(new LdcInsnNode(id));
            ...
            hook.add(call("onObjectValue", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
            hook.add(new TypeInsnNode(Opcodes.CHECKCAST, arguments[argumentIndex].getInternalName()));
    ...
    private static void appendVoidCancellation(InsnList hook) {
        LabelNode proceed = new LabelNode();
        hook.add(new JumpInsnNode(Opcodes.IFNE, proceed));
        hook.add(new InsnNode(Opcodes.RETURN));
        hook.add(proceed);
    ...
    private static InsnList thisCall(String hookName) {
        InsnList result = new InsnList();
        loadThisAndCall(result, hookName);
        return result;
    }

    private static void loadThisAndCall(InsnList instructions, String hookName) {
    ...
    private static void beforeReturns(MethodNode method, int opcode, Instructions factory) {
        for (AbstractInsnNode instruction : method.instructions.toArray()) {
            if (instruction.getOpcode() == opcode) {
                method.instructions.insertBefore(instruction, factory.create());
            }
        }
    }
    ...
    private static boolean containsHook(MethodNode method, TargetMethod target) {
        ...
        String hookName = switch (target.hook()) {
            ...
            case OBJECT_RETURN, OBJECT_ARGUMENT, ITEM_STACK_ARGUMENT_5, OBJECT_INVOKE_RETURN -> "onObjectValue";
            ...
            case CHAMS_REMAP_SUBMIT_MODEL, CHAMS_FOIL_BUFFER,
                    CHAMS_FOIL_BUFFER_26_2 -> "onObjectValue";
            case CHAMS_MARK_ITEM, CHAMS_ITEM_RENDER, CHAMS_MARK_ITEM_26_2,
                    CHAMS_ITEM_PREPARE_26_2, HAND_ANIMATION -> "onVoidHook";
        };
        for (AbstractInsnNode instruction : method.instructions) {
    ...
    private static boolean containsIdentifiedHook(MethodNode method, String id, String hookName) {
        boolean foundId = false;
        for (AbstractInsnNode instruction : method.instructions) {
            if (instruction instanceof LdcInsnNode constant && id.equals(constant.cst)) {
                foundId = true;
            } else if (foundId && instruction instanceof MethodInsnNode call
                    && call.getOpcode() == Opcodes.INVOKESTATIC
                    && call.owner.equals(BRIDGE)
    ...
    @FunctionalInterface
    private interface Instructions { InsnList create(); }
}
