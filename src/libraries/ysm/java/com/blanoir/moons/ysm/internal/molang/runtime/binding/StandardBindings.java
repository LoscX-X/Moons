package com.blanoir.moons.ysm.internal.molang.runtime.binding;

import com.blanoir.moons.ysm.internal.molang.parser.ast.AssignableVariableExpression;
import com.blanoir.moons.ysm.internal.molang.parser.ast.ExecutionScopeExpression;
import com.blanoir.moons.ysm.internal.molang.parser.ast.Expression;
import com.blanoir.moons.ysm.internal.molang.runtime.AssignableVariable;
import com.blanoir.moons.ysm.internal.molang.runtime.ExpressionEvaluatorImpl;
...
public final class StandardBindings {
    ...
    public static final Function LOOP_FUNC =
            (ctx, args) -> {
                if (args.size() < 2) {
                    return null;
                }
                ...
                if (expr instanceof ExecutionScopeExpression)
                    ((ExpressionEvaluatorImpl<?>) ctx)
                            .loopFunciton((ExecutionScopeExpression) expr, n);
                return null;
            };

    public static final Function FOR_EACH_FUNC =
            (ctx, args) -> {
                // Parameters:
                // - any:              Variable
                // - array:            Any array
                ...
                final AssignableVariable variableAccess =
                        ((AssignableVariableExpression) variableExpr).target();
